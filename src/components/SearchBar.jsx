...
const SearchBar = ({recipeList, setFilteredList}) => {
    ...
    return (
        <form className="recipe-search-bar" onSubmit={(e)=> {e.preventDefault();}}>
            ...
            <button type="Submit" className="w-30 h-15 bg-[#FF2C2C] text-white hover:bg-[#F43378] border-[#FF2C2C] border-white rounded-md border-solid border-2 cursor-pointer" onClick={searchhandler}> Search </button>
